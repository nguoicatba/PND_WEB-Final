...
namespace PND_WEB.Controllers
{
    public class ContInvoiceController : Controller
    {
        ...
        public ContInvoiceController(ILogger<HomeController> logger, DataContext context, IConverter converter, IViewRenderService viewRenderService)
        {
            _logger = logger;
            _context = context;
        ...
        public async Task<IActionResult> Create(InvoiceEditModel invoiceEditModel)
        {
            if (ModelState.IsValid)
            {
                if (invoiceEditModel.invoice != null) // Ensure invoice is not null  
                {
                    ...
                    {
                        DebitId = await GenerateCode("CONT"),
